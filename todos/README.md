...
M2+M4+M1 → M5 IM 渠道 + Bus 完善 → M6 验收 → T1 命名债 → T2 UI 精修（均 M6 后）
```
...
| [T1-routing-naming.md](./T1-routing-naming.md) | **M6 后** 路由/文案命名债偿还（非 parity） |
| [T2-ui-polish.md](./T2-ui-polish.md) | **M6 后** Web UI 视觉精修（建议 T1 后；可选 Pencil） |
