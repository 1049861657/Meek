...
export function LightningIcon(props: IconProps): ReactElement {
  return (
...
export function CogIcon(props: IconProps): ReactElement {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" {...props}>
      <path
        strokeLinecap="round"
...
export function LayoutIcon(props: IconProps): ReactElement {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true" {...props}>
      <path
        strokeLinecap="round"
